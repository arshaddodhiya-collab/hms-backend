...
public interface LabRequestRepository extends JpaRepository<LabRequest, Long> {
        ...
        @org.springframework.data.jpa.repository.EntityGraph(attributePaths = { "labTest", "labTest.parameters",
                        "labResults" })
        org.springframework.data.domain.Slice<LabRequest> findByEncounterId(Long encounterId,
        ...
        @org.springframework.data.jpa.repository.EntityGraph(attributePaths = { "labTest", "labTest.parameters",
                        "labResults" })
        org.springframework.data.domain.Slice<LabRequest> findByStatusIn(List<LabRequestStatus> statuses,
                        org.springframework.data.domain.Pageable pageable);
